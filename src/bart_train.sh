...
python -m torch.distributed.launch --nproc_per_node=2 examples/pytorch/summarization/run_summarization.py \
    ...
    --do_eval \
    --do_predict \
    --output_dir /disk1/sajad/saved_models/led-large-govrep \
    ...
    --train_file /disk1/sajad/gov-reports/train.jsonl \
    --validation_file /disk1/sajad/gov-reports/val.jsonl \
    --test_file /disk1/sajad/gov-reports/test.jsonl \
